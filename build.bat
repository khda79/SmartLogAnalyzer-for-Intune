...
python -m PyInstaller --onefile --windowed --name "SmartLogAnalyzer" --icon "logo.ico" --add-data "modules;modules" --add-data "logo.ico;." --hidden-import "modules.zip_handler" --hidden-import "modules.mdm_parser" --hidden-import "modules.error_detector" --hidden-import "modules.compliance_checker" --hidden-import "modules.report_generator" --hidden-import "modules.wu_parser" --hidden-import "modules.extra_parser" --hidden-import "modules.mdm_diag_parser" --hidden-import "modules.evtx_parser" --hidden-import "modules.device_parser" --hidden-import "modules.hardware_parser" --hidden-import "modules.ai_analyzer" --hidden-import "modules.health_analyzer" --hidden-import "modules.local_collector" --hidden-import "tkinter" --hidden-import "tkinter.ttk" --hidden-import "tkinter.filedialog" --hidden-import "tkinter.messagebox" --hidden-import "xml.etree.ElementTree" SmartLogAnalyzer.py
